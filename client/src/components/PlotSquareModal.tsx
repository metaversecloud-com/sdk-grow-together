...
// components
import { ModalHeader, HarvestButton, WaterButton } from "@/components";
    ...
    <div className="modal-container">
      <div className="modal">
        ...
        <div className="actions">
          ...
          <button className="btn btn-danger-outline" onClick={() => handleClearSquare()} disabled={areButtonsDisabled}>
            Remove
          </button>
        </div>
      </div>
